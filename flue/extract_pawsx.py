...
def get_labels(line, do_lower=False):
    ...
    sent1 = clean(sent1, no_line_breaks=True, lower=do_lower)
    sent2 = clean(sent2, no_line_breaks=True, lower=do_lower)
...
def main():
    ...
    parser.add_argument('--do_lower', action='store_true', help='True if do lower case, False otherwise.')
    parser.add_argument('--use_hugging_face', action='store_true', help='Prepare data to run fine-tuning using \
